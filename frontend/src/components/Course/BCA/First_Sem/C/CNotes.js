...
export default function BasicTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const listRef = ref(storage, "MCA/First/First_Sem/JAVA/JAVA/UserNotes");
  ...
  const handleNoteUpload = async () => {
    const storageRef = ref(storage, "MCA/First/First_Sem/JAVA/JAVA/UserNotes");
  ...
  return (
    <>
      <Container className="container">
        <Box margin="25px">
          <Typography variant="h5">C Programming</Typography>
        </Box>
